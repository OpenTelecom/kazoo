...
The current development target environment is:

-   **Erlang/OTP 27**
-   **macOS**

Development *should* still be possible on other platforms, but macOS is
the primary and tested development environment at this time.
